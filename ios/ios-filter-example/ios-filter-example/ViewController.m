...
// Get just 3 products
// http://localhost:3000/api/products?filter%5Blimit%5D=2

// Get a specific product
// http://localhost:3000/api/products?filter[where][name]=product%20H


// http://localhost:3000/api/products?filter[order]=inventory%20ASC&filter[limit]=3':

// The highest inventory products


// Get where geo near
// http://localhost:3000/api/locations?filter[where][geo][near]=4,10

// Get locations near (37.587409 -122.338225 )
// http://localhost:3000/api/location/nearby?here%5Blat%5D=37.587409&here%5Blng%5D=-122.338225
...
- (IBAction)actionInjectSomeData:(id)sender {
    ...
    void (^loadSuccessBlock)(NSArray *) = ^(NSArray *models) {
        ...
        //if ( models.count <= 0 )
        {
            ...
            [ [prototype modelWithDictionary:@{ @"name": @"ProductA", @"inventory" : @11, @"price" :@66.34 , @"units-sold" : @11 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductB", @"inventory" : @84, @"price" :@22.34 , @"units-sold" : @22 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductC", @"inventory" : @33, @"price" :@31.54 , @"units-sold" : @44 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductD", @"inventory" : @12, @"price" :@16.54 , @"units-sold" : @55 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductE", @"inventory" : @22, @"price" :@21.54 , @"units-sold" : @66 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductF", @"inventory" : @123, @"price" :@1.14 , @"units-sold" : @77 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
            [ [prototype modelWithDictionary:@{ @"name": @"ProductH", @"inventory" : @45, @"price" :@33.54 , @"units-sold" : @88 }]  saveWithSuccess:saveNewSuccessBlock failure:saveNewErrorBlock];
